...
!(function (e, n, A) {
  ...
  function i(e, n) {
    if (typeof e === 'object') for (const A in e) f(e, A) && i(A, e[A]);
    else {
      e = e.toLowerCase();
      const o = e.split('.');
      let t = Modernizr[o[0]];
      if ((o.length == 2 && (t = t[o[1]]), typeof t !== 'undefined'))
        return Modernizr;
  ...
  var c = u.nodeName.toLowerCase() === 'svg';
  !(function () {
    ...
    Modernizr.addAsyncTest(function () {
      function e(e, n, A) {
        function o(n) {
          let o = n && n.type === 'load' ? t.width == 1 : !1;
          const a = e === 'webp';
      ...
      e(A.name, A.uri, function (A) {
        if (A && A.type === 'load')
          for (let o = 0; o < n.length; o++) e(n[o].name, n[o].uri);
      });
    }),
    t(),
    a(s),
